...
describe("Desafios de Objetos.", () => {
  describe(" 01 - Testando a Função fantasyGame.", () => {
    it("Verifica o correto retorno para o argumento Mago.", () => {
      expect(fantasyGame("Mago")).toEqual("Mago, 5PV.");
    });
    it("Verifica o correto retorno para o argumento Arqueiro.", () => {
      expect(fantasyGame("Arqueiro")).toEqual("Arqueiro, 10PV.");
    });
    it("Verifica o correto retorno para o argumento Guerreiro.", () => {
      expect(fantasyGame("Guerreiro")).toEqual("Guerreiro, 15PV.");
    });
    it("Verifica o correto retorno para o argumento Cavaleiro.", () => {
  ...
  describe(" 03 - Testando a Função musicalScale.", () => {
    it("Verifica o correto retorno para o argumento Dó.", () => {
      expect(musicalScale("Dó")).toEqual("I");
    });
    it("Verifica o correto retorno para o argumento Ré.", () => {
      expect(musicalScale("Ré")).toEqual("II");
    });
    it("Verifica o correto retorno para o argumento Mi.", () => {
      expect(musicalScale("Mi")).toEqual("III");
    });
    it("Verifica o correto retorno para o argumento Fá.", () => {
      expect(musicalScale("Fá")).toEqual("IV");
    });
    it("Verifica o correto retorno para o argumento Sol.", () => {
      expect(musicalScale("Sol")).toEqual("V");
    });
    it("Verifica o correto retorno para o argumento Lá.", () => {
      expect(musicalScale("Lá")).toEqual("VI");
    });
    it("Verifica o correto retorno para o argumento Si.", () => {
      expect(musicalScale("Si")).toEqual("VII");
    });
  });

  describe(" 04 - Testando a Função getOldPerson.", () => {
    it("Verifica o correto retorno da pessoa mais velha.", () => {
