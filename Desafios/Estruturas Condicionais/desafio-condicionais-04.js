...
Desenvolva a função `dinossauro`, que recebe uma string por parâmetro, que contém a situação de levantamento das pernas do dinossauro, e retorna o idioma em que ele irá falar.
